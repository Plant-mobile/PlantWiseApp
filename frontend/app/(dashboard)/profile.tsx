        ...
        <View style={[styles.container, { backgroundColor: theme.secondaryBackgroundColor }]}>
          ...
          <View style={styles.profileWrapper}>
            <View style={styles.cricle}>
              <Image
                source={
                  image ? { uri: image } : require('../../assets/profilePhoto.png')
                }
                style={styles.image}
                resizeMode="cover"
              />
              <TouchableOpacity onPress={pickImage} style={styles.cameraButton}>
                <Image source={require('../../assets/Icon-Cam.png')} />
              </TouchableOpacity>
            </View>
          ...
          <View style={styles.inputContainer}>
            <ThemedText style={styles.label}>{translation('g.user-Name')}</ThemedText>
            <Spacer height={10} />
            <TextInput
            ...
            <ThemedText style={styles.label}>{translation('g.current_password')}</ThemedText>
            <Spacer height={10} />
            <TextInput
              style={[styles.input, styles.boxShadow, { backgroundColor: theme.inputBackgroundColor }]}
            ...
            <ThemedText style={styles.label}>{translation('g.new_password')}</ThemedText>
            <Spacer height={10} />
            <TextInput
              style={[styles.input, styles.boxShadow, { backgroundColor: theme.inputBackgroundColor }]}
              value={newPassword}
            ...
            <ThemedText style={styles.label}>{translation('g.confirm_new_password')}</ThemedText>
            <Spacer height={10} />
            <TextInput
              style={[styles.input, styles.boxShadow, { backgroundColor: theme.inputBackgroundColor }]}
