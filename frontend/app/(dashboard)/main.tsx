        ...
        <ThemedView style={[styles.container, { height: screenHeight }]}>
          ...
          <ThemedView style={styles.contentContainer}>
            <Pressable onPress={goToAI}>
               {colorScheme == "dark" ? (
                <Image
                  source={require("../../assets/home/homeAIDark.png")}
                  style={styles.img}
                />
              ) : (
                <Image
            ...
            <Pressable onPress={goToFertilizers}>
               {colorScheme == "dark" ? (
                <Image
                  source={require("../../assets/home/homeFertilizersDark.png")}
                  style={styles.img}
                />
              ) : (
                <Image
            ...
            <Pressable onPress={goToPlants}>
              {colorScheme == "dark" ? (
                <Image
                  source={require("../../assets/home/homeGuideDark.png")}
                  style={styles.img}
                />
              ) : (
                <Image
            ...
            <Pressable onPress={goToPlants}>
               {colorScheme == "dark" ? (
                <Image
                  source={require("../../assets/home/homeHelpDark.png")}
                  style={styles.img}
                />
              ) : (
                <Image
